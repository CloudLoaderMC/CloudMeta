...
import ml.cloudmc.meta.web.models.BaseVersion;
...
public class ServerBootstrap {
    ...
    private static Handler boostrapHandler() {
        return ctx -> {
            ...
            final String installerVersion = getAndValidateVersion(ctx, CloudMeta.database.installer, "installer_version");
            final String gameVersion = getAndValidateVersion(ctx, CloudMeta.database.game, "game_version");
            final String loaderVersion = getAndValidateVersion(ctx, CloudMeta.database.getAllLoader(), "loader_version");
